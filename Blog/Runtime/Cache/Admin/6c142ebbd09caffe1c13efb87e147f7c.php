...
<div class="container">
  ...
  <form class="form-horizontal" role="form" method="post" action="<?php echo U('Update');?>" id="forms">
    <div class="MiniBox2">
      <label for="exampleInputEmail1">图片格式</label>
      <input type="text" class="form-control miniinput" name="mi_exts" value="<?php echo (C("mi_exts")); ?>">
      <label for="exampleInputEmail1">图片大小</label>
      <input type="text" class="form-control miniinput"  name="mi_maxSize" value="<?php echo (C("mi_maxSize")); ?>">
      <label for="exampleInputEmail1">图片最大宽度</label>
      <input type="text" class="form-control miniinput" name="mi_thumbMaxWidth" value="<?php echo (C("mi_thumbMaxWidth")); ?>">
      <label for="exampleInputEmail1">图片最大高度</label>
      <input type="text" class="form-control miniinput" name="mi_thumbMaxHeight" value="<?php echo (C("mi_thumbMaxHeight")); ?>">
      <button type="submit" class="btn btn-info ">更新图片配置</button>
    </div>
  </form>
      <div class="footer">
