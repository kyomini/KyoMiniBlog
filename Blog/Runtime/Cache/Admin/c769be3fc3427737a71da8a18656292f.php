...
<div class="container"> 
  ...
  <div class="MiniBox2">
    <form role="form" method="post" action="<?php echo U('update');?>">
      <div class="MiniBox2_left">
        <input type="text" class="form-control miniinput" placeholder="名称" name="title" value="<?php echo ($one["title"]); ?>"/>
      </div>
      <textarea class="form-control miniinput3" rows="20" id="editor_id" name="content"><?php echo ($one["content"]); ?></textarea>
      <input type="text" class="form-control miniinput" placeholder="描述"  style="margin-top:20px" name="keywords" value="<?php echo ($one["keywords"]); ?>"/>
      <input type="text" class="form-control miniinput" placeholder="关键词" name="description" value="<?php echo ($one["description"]); ?>"/>
      
      
             <input type="hidden" name="pid" value="<?php echo ($one["pid"]); ?>">

      <button type="submit" class="btn btn-info minibtn">修改</button>
