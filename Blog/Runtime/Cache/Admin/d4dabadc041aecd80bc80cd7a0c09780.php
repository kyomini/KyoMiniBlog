 ...
 <span id="result"></span>
    <div class="container">
        ...
        <form class="form-horizontal" role="form" method="post" action="<?php echo U('Update');?>" id="forms">
            <div class="MiniBox2">
                <label for="exampleInputEmail1"><?php echo (L("lang_default")); ?></label>
                <input type="text" class="form-control miniinput" value="<?php echo (C("LANG_LIST")); ?>" disabled>
                <label for="exampleInputEmail1"><?php echo (L("lang_Modify")); ?></label>
                <select class="form-control miniinput2" name="LANG_LIST">
                    <option value="zh-cn"><?php echo (L("Chinese_cn")); ?></option>
                    <option value="zh-tw"><?php echo (L("Chinese_tw")); ?></option>
                    <option value="jp"><?php echo (L("Japanese")); ?></option>
                    <option value="en-us"><?php echo (L("lang_enlish")); ?></option>
                </select>
                <button type="submit" class="btn btn-info "><?php echo (L("_Safe_")); echo (L("_Language_")); ?></button> 
                <a class="btn btn-info" href="<?php echo U('/Admin/Lang');?>?l=<?php echo (C("LANG_LIST")); ?>">
      <?php echo (L("_Change_")); ?> <?php echo (C("LANG_LIST")); ?></a>
            </div>
        </form>
          <div class="footer">
