...
<select class="form-control miniinput2" name="cid">
   ...
   <input type="radio" name="hot" value = "1" id="optionsRadios1" checked> 
   &nbsp;默 认&nbsp;
<input type="radio" name="hot" value = "0" >
  ...
  <div class="btn-group">
  <button type="button" class="btn btn-info minibtn dropdown-toggle" data-toggle="dropdown">选择 <span class="caret"></span></button>

  <ul class="dropdown-menu" role="menu">
    <li><a href="#" id="reset">重写</a></li>
    <li>
    <a href="#" id="write_high_open">高级</a>
